      ...
      <div className="bg-gradient-to-br from-[#4a0b13] via-[#6B0F1A] to-[#4a0b13] text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <p className="text-[#F5E6C8] max-w-2xl text-sm sm:text-base leading-relaxed">
            ...
            System &mdash; from signing in to managing classes, students, activities, exams, and grades.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <Section id="overview" icon={<Lightbulb className="w-5 h-5" />} title="Overview">
          <p>
            ...
            a class &mdash; rosters, graded activities, exams, and performance analytics &mdash; in one place.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Create activities and exams, then record scores for each student.</li>
        ...
        <Section id="getting-started" icon={<LogIn className="w-5 h-5" />} title="Getting Started">
          ...
          <p>
            ...
            Classes, Students, Activities, and Exams. Click your avatar or name at the top of
        ...
        <Section id="dashboard" icon={<LayoutDashboard className="w-5 h-5" />} title="Dashboard">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Stat cards</strong> &mdash; totals for classes, students, activities, and class average.</li>
          ...
          <h3 className="font-semibold text-gray-800 mt-4">Filtering by Term, Period, and Academic Year</h3>
          <p>
            The welcome line at the top of the Dashboard contains three inline dropdowns that control
            the scope of every card and chart below. Change any one of them and the entire view
            refreshes to match.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <strong>Term</strong> &mdash; pick <em>1st Semester</em>, <em>2nd Semester</em>,{' '}
              <em>3rd Semester</em>, or <em>Summer</em>. Only classes tagged with the selected term
              (and academic year) are counted in <em>Total Classes</em> and listed under{' '}
              <em>My Classes</em>.
            </li>
            <li>
              <strong>Period</strong> &mdash; choose <em>Prelim</em>, <em>Midterm</em>, or{' '}
              <em>Finals</em>. Grade components, averages, pass/fail counts, and the distribution
              chart all reflect the scores you&rsquo;ve recorded for that period. Prelim reads the
              top-level grade sheet; Midterm and Finals read their dedicated grade buckets.
            </li>
            <li>
              <strong>Academic Year</strong> &mdash; switch between <em>2025&ndash;2026</em>,{' '}
              <em>2026&ndash;2027</em>, or <em>2027&ndash;2028</em>. Combined with Term, this
              isolates classes (and the students inside them) from a specific school year.
            </li>
            <li>
              <strong>Total Students</strong> counts unique individuals in the filtered scope &mdash;
              a student enrolled in multiple classes during the same term is counted once.
            </li>
            <li>
              If no data exists for the selected combination, the Dashboard shows a friendly hint
              under the filters instead of empty charts.
            </li>
          </ul>
        </Section>
        ...
        <Section id="classes" icon={<BookOpen className="w-5 h-5" />} title="Classes">
          <p>
            ...
            a name, course code, section, class type, academic year, term, year level, faculty,
            schedule, and assigned room.
          </p>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h3 className="font-semibold text-gray-800 mt-4">Class type &mdash; LAB, LEC, or GEC</h3>
          <p>
            Every class is tagged with one of three types. The type appears as a badge on the class
            card and in the list view so you can tell them apart at a glance.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>LEC</strong> &mdash; Lecture. Discussion-style classes held in a regular classroom.</li>
            <li><strong>LAB</strong> &mdash; Laboratory. Hands-on sessions, typically longer and scheduled in a dedicated lab (for example, the IoT Lab).</li>
            <li><strong>GEC</strong> &mdash; General Education Course. University-wide core subjects outside the main program.</li>
          </ul>
          <p className="text-xs text-gray-500">
            Class type is required when creating or editing a class.
          </p>

          <h3 className="font-semibold text-gray-800 mt-4">Schedule &mdash; days and times</h3>
          <p>
            The schedule field is built from a day picker and a time range rather than free text,
            so every class has a consistent format.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <strong>Meeting days</strong> &mdash; tap any combination of <em>Mon</em> through{' '}
              <em>Sun</em>. At least one day is required.
            </li>
            <li>
              <strong>Start and end time</strong> &mdash; pick times from the 24-hour time pickers;
              the preview shows the result in 12-hour format (e.g., <code className="bg-gray-100 px-1 rounded">MWF 9:00 AM - 10:30 AM</code>).
            </li>
            <li>
              End time must come after start time &mdash; the form will block saves that don&rsquo;t
              satisfy this.
            </li>
            <li>
              Existing schedules stored as free text are parsed automatically when you open a class
              for editing, so nothing is lost.
            </li>
          </ul>
        </Section>
        ...
        <Section id="students" icon={<Users className="w-5 h-5" />} title="Students">
          <p>
            Use the Students section to maintain your roster. You can enroll students into one or
            more classes and view their academic record.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>Add a student by filling in their last name, first name, middle initial, student number, year level, college program, and at least one class assignment.</li>
            <li>Open a student profile to view or update grade components (Exams, Activities, Class Participation, Major Exam).</li>
            <li>The system automatically computes the final grade and equivalent grade label (transmuted).</li>
          </ul>

          <h3 className="font-semibold text-gray-800 mt-4">Enrolling a student in multiple classes</h3>
          <p>
            Students are no longer tied to a single class. When you add or edit a student you can
            tick every class they belong to &mdash; across different terms, sections, or class
            types &mdash; and the system keeps those enrollments in sync as one student profile.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              In the <strong>Add Student</strong> and <strong>Edit Student</strong> dialogs, the{' '}
              <em>Classes</em> field is a checklist. Tick any combination; you must select at least
              one.
            </li>
            <li>
              Behind the scenes each tick creates (or keeps) a separate enrollment record linked to
              that class. Shared details &mdash; name, student number, year level, program, and
              academic year &mdash; stay aligned across all of them, so editing the student in one
              class updates the same person everywhere.
            </li>
            <li>
              On the Students list, a student&rsquo;s card shows every class they&rsquo;re assigned
              to. Un-ticking a class during edit removes that enrollment without deleting the
              student from the others.
            </li>
            <li>
              On the Dashboard, students enrolled in multiple classes within the same term and
              academic year are counted <strong>once</strong> in <em>Total Students</em>; their
              grades still contribute per class to the distribution and pass/fail charts.
            </li>
            <li>
              The class filter at the top of the Students page narrows the roster to a single
              class, which is useful when you want to work with one section at a time.
            </li>
          </ul>
        </Section>

        {/* Activities */}
        <Section id="activities" icon={<ClipboardList className="w-5 h-5" />} title="Activities">
          <p>
            Create and manage graded coursework in the Activities section.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>Add a new activity with a title, description, class, due date, and total points.</li>
            <li>Mark activities as <strong>Active</strong> while they&rsquo;re open for submissions, or <strong>Closed</strong> once grading is complete.</li>
            <li>Record individual student scores directly from the activity detail page.</li>
          </ul>
        </Section>

        {/* Exams */}
        <Section id="exams" icon={<HelpCircle className="w-5 h-5" />} title="Exams">
          <p>
            The Exams section works similarly to Activities but is dedicated to graded
            assessments.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>Create an exam tied to a specific class and set its total points.</li>
            <li>Enter scores for each student; the dashboard and student profile update automatically.</li>
            <li>Use exams to track progress throughout the term.</li>
          </ul>
        </Section>
        ...
        <Section id="profile" icon={<UserCog className="w-5 h-5" />} title="Profile & Settings">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Email notifications</strong> &mdash; opt in to announcements about activities and grading.</li>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Export all data</strong> &mdash; downloads a CSV file containing your profile, preferences, classes, students, activities, exams, and per-class grade sheets.</li>
            <li><strong>Reset LMS data</strong> &mdash; clears classes, students, and activities stored on this device after a confirmation prompt. Your account and login are preserved. This action cannot be undone, so export first if you want a backup.</li>
          </ul>
        </Section>
        ...
        <Section id="faq" icon={<CheckCircle2 className="w-5 h-5" />} title="FAQ & Support">
          ...
          <FAQ
            ...
            a="Most sections require authentication. Sign in with your account to access the Dashboard, Classes, Students, Activities, Exams, and Profile."
          />
          <FAQ
          ...
          <FAQ
            ...
            a="Double-check the individual component scores for the student. Final grades are derived from Exams, Activities, Class Participation, and the Major Exam."
          />
          <FAQ
